...
class NaturalOrderingTest {
    ...
    void test_naturalOrder_strings() throws Exception {
        ...
        actual.sort(unchecked(naturalOrder()));
    ...
    void test_naturalOrder_strings_reversed() throws Exception {
        ...
        actual.sort(unchecked(CheckedComparator.<String>naturalOrder().reversed()));
    ...
    void test_naturalOrder_ints_reversed() throws Exception {
        ...
        actual.sort(unchecked(CheckedComparator.<Integer>naturalOrder().reversed()));
    ...
    void test_naturalOrder_ints_npe() throws Exception {
        ...
        assertThrows(NullPointerException.class, () -> actual.sort(unchecked(naturalOrder())));
    }
