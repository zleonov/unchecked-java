Unchecked Java
===============
Offering the capability to handle checked exceptions as if they were unchecked, enabling the creation of lambda expressions that are safe from checked-exception side effects.
